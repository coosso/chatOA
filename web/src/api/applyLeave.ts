...
const url = "https://demo.tuoluojiang.com/api/ent/approve/apply/save/98";
...
const body = {
  formInfo: {
    F60m1pf6z02ws6: 2,
    Fngq1pf6z02ws7: {
      dateStart: "2025/11/18 00:00:00",
      timeStart: "1",
      dateEnd: "2025/11/22 00:00:00",
      timeEnd: "1",
      duration: "120.00",
      timeType: "time",
    },
...
export async function applyLeave(data: ApplyLeaveChatResponse) {
  body.formInfo.Fngq1pf6z02ws7.dateStart = data.dateStart;
  body.formInfo.Fngq1pf6z02ws7.dateEnd = data.dateEnd;
  body.formInfo.Fngq1pf6z02ws7.duration = "24.00";
  body.formInfo.F63x1pf6z02ws8 = data.reason;
  console.log(data);
